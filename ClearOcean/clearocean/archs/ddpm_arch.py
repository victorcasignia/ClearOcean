...
class GaussianDiffusion(nn.Module):
    ...
    def set_new_noise_schedule(self, schedule_opt, device):
        ...
        self.register_buffer('sqrt_alphas_cumprod_prev_tensor', to_torch(self.sqrt_alphas_cumprod_prev))
    ...
    def ddim_pyramid_sample(
        ...
        for i in tqdm(reversed(range(0, ddim_timesteps)), desc='sampling loop time step', total=ddim_timesteps):
            ...
            noise_level = self._extract(self.sqrt_alphas_cumprod_prev_tensor, t + 1, sample_img.shape).view(b, 1)
            ...
            if self.color_fn and torch.min(t) > self.color_limit:
    ...
    def p_losses(self, x_HR, x_SR, noise=None, different_t_in_one_batch=False, t_sample_type=None, pred_type='noise', clip_noise=False,\
        ...
        if different_t_in_one_batch:
            ...
            continuous_sqrt_alpha_cumprod = self._extract(self.sqrt_alphas_cumprod_prev_tensor, t, x_start.shape)
